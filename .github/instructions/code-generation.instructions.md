...
See [Testing Standards](testing.instructions.md) for comprehensive guidance on:
- Unit testing generator pipeline components
- Integration testing full generator execution
