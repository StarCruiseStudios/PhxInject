...
Standards for writing C# code in this repository. These apply to all projects except generated code (see [Code Generation Practices](code-generation.instructions.md)).
...
3. **Document edge cases**:
   ...
   ```
4. **Use XML documentation** for public APIs (see [Documentation Standards](documentation.instructions.md))
