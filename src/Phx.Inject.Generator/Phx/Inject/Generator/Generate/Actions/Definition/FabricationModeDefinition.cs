// -----------------------------------------------------------------------------
//  <copyright file="FabricationModeDefinition.cs" company="Star Cruise Studios LLC">
...
namespace Phx.Inject.Generator.Actions.Definition {
    /// <summary>
    ///     Enumerates the modes of fabrication that can be used by a factory
    ///     method.
    /// </summary>
    public enum FabricationModeDefinition {
        /// <summary>
