...
/// <summary>
///     Metadata representing an analyzed [ChildInjector] attribute.
/// </summary>
...
internal record ChildInjectorAttributeMetadata(
    ...
    /// <summary> The fully-qualified name of the ChildInjector attribute class. </summary>
    public const string AttributeClassName = $"{PhxInject.NamespaceName}.{nameof(ChildInjectorAttribute)}";
