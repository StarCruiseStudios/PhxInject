...
/// </summary>
/// <remarks>
///     Extracts marker type from <c>[Qualifier(typeof(TMarker))]</c> for type-based dependency
///     discrimination (compile-time safe alternative to string labels). Extracts <c>ITypeSymbol</c>
///     via <c>GetConstructorArgument</c> and converts to <c>TypeModel</c> for incremental cache
///     stability. Null-forgiving operator safe because <c>QualifierAttribute</c> constructor requires
///     non-null <c>Type</c> parameter.
/// </remarks>
///             <description>
