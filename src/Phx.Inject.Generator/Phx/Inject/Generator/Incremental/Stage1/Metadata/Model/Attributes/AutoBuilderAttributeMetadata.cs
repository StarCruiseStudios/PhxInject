// -----------------------------------------------------------------------------
// <copyright file="AutoBuilderAttributeMetadata.cs" company="Star Cruise Studios LLC">
...
/// <summary>
///     Metadata representing an analyzed [AutoBuilder] attribute.
/// </summary>
/// <param name="AttributeMetadata"> The underlying attribute metadata. </param>
internal record AutoBuilderAttributeMetadata(
    AttributeMetadata AttributeMetadata
) : IAttributeElement {
    /// <summary> The fully-qualified name of the AutoBuilder attribute class. </summary>
