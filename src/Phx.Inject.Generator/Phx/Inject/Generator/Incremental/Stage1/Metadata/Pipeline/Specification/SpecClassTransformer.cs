// -----------------------------------------------------------------------------
// <copyright file="SpecClassTransformer.cs" company="Star Cruise Studios LLC">
...
/// <summary>
///     Transforms specification class declarations into metadata.
/// </summary>
internal sealed class SpecClassTransformer(
...
) : ITransformer<ITypeSymbol, SpecClassMetadata> {
    /// <summary>
    ...
    /// <inheritdoc />
    public IResult<SpecClassMetadata> Transform(ITypeSymbol typeSymbol) {
