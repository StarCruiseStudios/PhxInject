// -----------------------------------------------------------------------------
// <copyright file="SpecInterfaceTransformer.cs" company="Star Cruise Studios LLC">
...
/// <summary>
///     Transforms specification interface declarations into metadata.
/// </summary>
internal sealed class SpecInterfaceTransformer(
...
) : ITransformer<ITypeSymbol, SpecInterfaceMetadata> {
    /// <summary>
    ...
    /// <inheritdoc />
    public IResult<SpecInterfaceMetadata> Transform(ITypeSymbol typeSymbol) {
        return DiagnosticsRecorder.Capture(diagnostics => {
            ...
            var specInterfaceType = typeSymbol.ToTypeModel();
            ...
            var links = linkAttributeTransformer.Transform(typeSymbol);
