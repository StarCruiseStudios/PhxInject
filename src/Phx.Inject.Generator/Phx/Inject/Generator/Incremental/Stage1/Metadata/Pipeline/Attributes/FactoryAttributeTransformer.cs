...
/// </summary>
/// <remarks>
///     Extracts configuration from <c>[Factory]</c> attributes marking methods that generate factory
///     implementations. Extracts FabricationMode enum controlling instantiation strategy (Constructor,
///     StaticMethod, or Default). Validation of appropriateness for target type is deferred to validators.
/// </remarks>
