...
internal class SpecClassSyntaxValuesProvider : IAttributeSyntaxValuesProvider<SpecClassMetadata> {
    public static readonly SpecClassSyntaxValuesProvider Instance = new();
    ...
    public SpecClassMetadata Transform(
