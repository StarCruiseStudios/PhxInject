...
/// <summary>
///     Code generation model representing an invocation of a specification container factory method.
/// </summary>
...
/// <remarks>
///     Represents a chain of factory calls needed to satisfy a dependency. For simple dependencies,
///     this is a single call. For cross-spec dependencies, this chains multiple calls.
/// </remarks>
/// <param name="FactoryInvocationDefs"> The factory invocations to chain together. </param>
/// <param name="FactoryReturnType"> The return type of the factory invocation. </param>
/// <param name="RuntimeFactoryProvidedType"> The optional runtime-provided type for the factory. </param>
