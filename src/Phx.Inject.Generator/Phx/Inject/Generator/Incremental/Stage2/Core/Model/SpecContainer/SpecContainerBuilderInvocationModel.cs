...
/// <summary>
///     Code generation model for an invocation of a specification container builder method.
/// </summary>
...
/// <remarks>
///     Represents a builder dependency in the dependency graph. While structurally similar to factory
///     invocations, builder invocations return <c>IBuilder&lt;T&gt;</c> for deferred creation.
/// </remarks>
/// <param name="SpecContainerType"> The specification container type. </param>
/// <param name="BuilderMethodName"> The name of the builder method to invoke. </param>
/// <param name="Location"> The source location where this invocation is defined. </param>
