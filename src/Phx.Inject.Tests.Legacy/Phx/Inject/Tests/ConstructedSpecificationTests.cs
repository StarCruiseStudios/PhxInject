...
[Injector("ConstructedParentInjector")]
...
public class ConstructedSpecificationTests : LoggingTestClass {
    ...
    public void ABasicConstructedSpecificationInjectorIsConstructed() {
        ...
        IConstructedSpecification spec = Given("A constructed specification.",
            () => new ConstructedSpecificationImplementation(intValue));
        IBasicConstructedInjector injector = Given("An injector built with the spec.",
            () => new BasicConstructedInjector(spec));
