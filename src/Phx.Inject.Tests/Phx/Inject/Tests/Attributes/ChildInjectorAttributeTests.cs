// -----------------------------------------------------------------------------
// <copyright file="ChildInjectorAttributeTests.cs" company="Star Cruise Studios LLC">
...
/// <summary>
/// Tests for <see cref="ChildInjectorAttribute"/>.
/// </summary>
public class ChildInjectorAttributeTests : LoggingTestClass {
    
    [Test]
    public void Constructor_CreatesInstance() {
        var attribute = When("Creating ChildInjectorAttribute",
            () => new ChildInjectorAttribute());
