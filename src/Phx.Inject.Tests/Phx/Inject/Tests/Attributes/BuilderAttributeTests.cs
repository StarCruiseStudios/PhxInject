// -----------------------------------------------------------------------------
// <copyright file="BuilderAttributeTests.cs" company="Star Cruise Studios LLC">
...
/// <summary>
/// Tests for <see cref="BuilderAttribute"/>.
/// </summary>
public class BuilderAttributeTests : LoggingTestClass {
    
    [Test]
    public void Constructor_CreatesInstance() {
        var attribute = When("Creating BuilderAttribute",
            () => new BuilderAttribute());
