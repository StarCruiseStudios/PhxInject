...
namespace Phx.Inject {
    ...
    public class InjectorAttribute : Attribute {
        ...
        /// <remarks>
        ///     This value may be null if no custom class name is specified. If no custom name is
        ///     specified a default value of "GeneratedXyz" will be used, where Xyz is the annotated
        ///     interface's name with the leading "I" removed, if there is one.
        /// </remarks>
